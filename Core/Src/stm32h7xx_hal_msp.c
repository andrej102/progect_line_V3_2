...
void HAL_COMP_MspInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP1_MspInit 0 */
    ...
    PB2     ------> COMP1_INP
    */
    GPIO_InitStruct.Pin = LINE1_REF_COM1_INM_Pin|LINE1_VIDEO_COMP1_INP_Pin;
...
void HAL_COMP_MspDeInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP1_MspDeInit 0 */
    ...
    PB2     ------> COMP1_INP
    */
    HAL_GPIO_DeInit(GPIOB, LINE1_REF_COM1_INM_Pin|LINE1_VIDEO_COMP1_INP_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PA7     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = LINE1_ST_TIM3_CH1_Pin|LED_IR_TIM3_CH2_Pin;
  ...
  /* USER CODE END TIM17_MspPostInit 0 */
    ...
    PB9     ------> TIM17_CH1
    */
    GPIO_InitStruct.Pin = LINE1_CLK_TIM17_CH1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM17;
    HAL_GPIO_Init(LINE1_CLK_TIM17_CH1_GPIO_Port, &GPIO_InitStruct);
